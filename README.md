...
1. Navigate to `https://old.reddit.com/r/YourSubreddit/about/stylesheet/`.
...
5. Save your Stylesheet changes!
6. Navigate to `https://old.reddit.com/r/YourSubreddit/about/edit/` and add a button under the Sidebar text area using the following example:
    * `######[Play Now!](https://old.reddit.com/r/Toontown/comments/1jg0ug7/toontown_private_server_master_list/)`
        * *If adding multiple buttons under the Sidebar text area, make sure that this button is the first button listed. Not doing so may have unexpected results...*
7. Save your subreddit settings!
